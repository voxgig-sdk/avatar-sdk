...
The PHP SDK for the Avatar API — an entity-oriented client using PHP conventions.
...
```php
// list() returns an array of Question records (throws on error).
...
The main class (`avatar_sdk.php`) exports the SDK class
