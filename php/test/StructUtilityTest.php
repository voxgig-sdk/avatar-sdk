...
// Avatar SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = AvatarOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(AvatarOmni::structfix($now, Struct::undef()))
                        !== json_encode(AvatarOmni::structfix($val, Struct::undef()))) {
