...
// Avatar SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (AvatarSDK::test)
...
{
    private const SDK_CLASS = 'AvatarSDK';
    ...
    private const SDK_BASE = 'avatar_sdk';
