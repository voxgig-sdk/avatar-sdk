...
class AvatarTestRunner
{
    ...
    {
        $live = self::getenv('AVATAR_TEST_LIVE');
        $override = self::getenv('AVATAR_TEST_OVERRIDE');
        ...
        $explain = self::getenv('AVATAR_TEST_EXPLAIN');
...
class_alias('AvatarTestRunner', 'Runner');
class_alias('AvatarHelpers', 'Helpers');
