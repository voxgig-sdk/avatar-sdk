...
{
    private static function utility(): AvatarUtility
    {
    ...
    private static function ctx(array $over = []): AvatarContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new AvatarContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new AvatarOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof AvatarError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new AvatarOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = AvatarMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new AvatarOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = AvatarMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new AvatarOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = AvatarMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new AvatarSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = AvatarMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            ...
            'result' => new AvatarResult([]),
        ]);
        [, $err] = AvatarMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new AvatarSpec(['step' => 's']),
            'response' => new AvatarResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new AvatarResult([]),
        ]);
        [, $err] = AvatarMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new AvatarSpec(['step' => 's']),
            'response' => new AvatarResponse(self::resp(200, ['v' => 1])),
            'result' => new AvatarResult([]),
        ]);
        [, $err] = AvatarMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new AvatarSpec(['step' => 's']),
            'response' => new AvatarResponse(self::resp(200, ['v' => 2])),
            'result' => new AvatarResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        AvatarMakeResponse::call($ctx);
    ...
    {
        $preset = new AvatarResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new AvatarSpec([]),
            'response' => new AvatarResponse([]),
            'result' => new AvatarResult([]),
        ...
        [$got, $err] = AvatarMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new AvatarResult([])]);
        [, $err] = AvatarMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new AvatarSpec([]), 'result' => null]);
        [, $err] = AvatarMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new AvatarSpec(['step' => 's']),
            'result' => new AvatarResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new AvatarOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = AvatarMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new AvatarSpec(['step' => 's']),
            'result' => new AvatarResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new AvatarOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = AvatarMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new AvatarResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new AvatarSpec([]),
            'result' => new AvatarResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = AvatarMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = AvatarMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new AvatarError('boom', 'boom');
        $utility->fetcher = function (AvatarContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new AvatarSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = AvatarMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (AvatarContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = AvatarMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(AvatarResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (AvatarContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new AvatarSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = AvatarMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new AvatarResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new AvatarSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = AvatarMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = AvatarMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = AvatarMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new AvatarResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, AvatarDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new AvatarResult(['ok' => false])]);
        $this->expectException(AvatarError::class);
        AvatarDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new AvatarResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', AvatarMakeError::call($ctx, null));
    }
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new AvatarBaseFeature();
        $b = new AvatarBaseFeature();
        AvatarFeatureAdd::call($ctx, $a);
        AvatarFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): AvatarBaseFeature
    {
        $f = new AvatarBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        AvatarFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): AvatarContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new AvatarSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = AvatarPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new AvatarResponse(['headers' => null]),
            'result' => new AvatarResult([]),
        ]);
        AvatarResultHeaders::call($ctx);
