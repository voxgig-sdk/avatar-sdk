...
class AvatarFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; AvatarSDK/1.0)';
    ...
    public static function call(AvatarContext $ctx, string $fullurl, array $fetchdef): array
    {
