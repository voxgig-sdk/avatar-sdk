...
class AvatarRbacFeature extends AvatarBaseFeature
{
    ...
    private function _required(AvatarContext $ctx): ?string
    {
    ...
    private function _reject(AvatarContext $ctx, string $required): void
    {
    ...
    private function _track(AvatarContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
