...
class AvatarProxyFeature extends AvatarBaseFeature
{
    ...
    public function init(AvatarContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (AvatarContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
