...
class AvatarCacheFeature extends AvatarBaseFeature
{
    ...
    private function _through(AvatarContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
