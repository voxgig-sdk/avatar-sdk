...
// Avatar SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class AvatarTestFeature extends AvatarBaseFeature
{
    ...
    public function init(AvatarContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (AvatarContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (AvatarContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(AvatarContext $ctx, $op, $args): array
    {
