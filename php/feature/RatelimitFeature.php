...
class AvatarRatelimitFeature extends AvatarBaseFeature
{
    ...
    private function _acquire(AvatarContext $ctx): void
    {
    ...
    private function _track(AvatarContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
