...
|---|---|---|
| `ts/` | @voxgig-sdk/avatar-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/avatar-sdk \
      --repository voxgig-sdk/avatar-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/avatar-sdk` shows it, and
`npm trust revoke @voxgig-sdk/avatar-sdk --id=<id>` removes it.
