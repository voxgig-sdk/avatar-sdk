...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = AvatarOmni.make_runner(TEST_JSON_FILE, AvatarSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : AvatarOmni.errify(err)
    end
