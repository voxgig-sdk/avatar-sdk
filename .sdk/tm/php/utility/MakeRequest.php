...
// Avatar SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class AvatarMakeRequest
{
    public static function call(AvatarContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new AvatarResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new AvatarResponse($fetched);
        } else {
