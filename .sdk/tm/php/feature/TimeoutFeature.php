...
class AvatarTimeoutFeature extends AvatarBaseFeature
{
    ...
    private function _with_timeout(AvatarContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(AvatarContext $_ctx, float $ms): void
    {
        $client = $this->client;
