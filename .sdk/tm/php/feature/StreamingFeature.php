...
class AvatarStreamingFeature extends AvatarBaseFeature
{
    ...
    private function _iterate(AvatarResult $result): \Generator
    {
    ...
    private function _streamable(AvatarContext $ctx): bool
    {
