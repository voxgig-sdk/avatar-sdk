...
class AvatarNetsimFeature extends AvatarBaseFeature
{
    ...
    private function _simulate(AvatarContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(AvatarContext $ctx, array $applied): void
    {
        $client = $this->client;
