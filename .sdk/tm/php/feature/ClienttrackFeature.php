...
// Avatar SDK clienttrack feature
...
class AvatarClienttrackFeature extends AvatarBaseFeature
{
    ...
    public function PostConstruct(AvatarContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Avatar-SDK';
