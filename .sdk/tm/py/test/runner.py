...
class AvatarTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AvatarTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = AvatarTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = AvatarTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
