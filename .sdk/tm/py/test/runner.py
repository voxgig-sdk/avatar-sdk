...
class AvatarTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AvatarTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = AvatarTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = AvatarTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
