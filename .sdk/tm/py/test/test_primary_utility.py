...
from projectname_sdk import AvatarSDK
from projectname_sdk.core.spec import AvatarSpec
from projectname_sdk.core.result import AvatarResult
from projectname_sdk.core.response import AvatarResponse
from projectname_sdk.core.operation import AvatarOperation
from projectname_sdk.core.error import AvatarError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import AvatarBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = AvatarSDK.test(None, None)
        ...
        class TestInitFeature(AvatarBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(AvatarBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = AvatarSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = AvatarSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = AvatarSDK.test(None, setup_opts)
