...
from projectname_sdk.core.control import AvatarControl
...
class AvatarContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, AvatarResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return AvatarError(code, msg, self)
