...
module AvatarTestRunner
  ...
  def self.env_override(m)
    live = getenv("AVATAR_TEST_LIVE")
    override = getenv("AVATAR_TEST_OVERRIDE")
    ...
    explain = getenv("AVATAR_TEST_EXPLAIN")
    m["AVATAR_TEST_EXPLAIN"] = explain if explain && !explain.empty?
