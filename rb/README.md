...
The Ruby SDK for the Avatar API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `AvatarError` (a `StandardError` subclass), so wrap
