...
func registerSDKWords(r *eng.Registry, client *sdk.AvatarSDK) {
...
func runOp(client *sdk.AvatarSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
