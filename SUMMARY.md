...
Results: Successful response with list of trivia questions; Successful response with trivia question details.
...
| Question | `list` | `GET /questions` | See reference |
| Question | `load` | `GET /questions/{id}` | See reference |

## Connect to the API

- Production server: `https://api.sampleapis.com/avatar`
...
- `avatar_list`: List records for an entity. Supported entities: `character`, `episode`, `question`.
- `avatar_load`: Load one record for an entity. Supported entities: `character`, `episode`, `question`.
