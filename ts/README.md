# Avatar TypeScript SDK



The TypeScript SDK for the Avatar API — a type-safe, entity-oriented client with full async/await support.
...
- Releases: [https://github.com/voxgig-sdk/avatar-sdk/releases](https://github.com/voxgig-sdk/avatar-sdk/releases)
...
| `tester(testopts?, sdkopts?)` | `AvatarSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `AvatarSDK.test(testopts?, sdkopts?)` | `AvatarSDK` | Create a test-mode client. |
...
| `client` | `client(): AvatarSDK` | Return the parent SDK client. |
...
```ts
const question = await client.Question().load({ id: 1 })
```
