...
func TestQuestionEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		questionRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.question")))
		...
		questionRef01DataDt0LoadResult := core.ToMapAny(entityData(questionRef01DataDt0Loaded))
