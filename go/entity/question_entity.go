...
func NewQuestionEntity(client *core.AvatarSDK, entopts map[string]any) *QuestionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *QuestionEntity) GetName() string { return e.name }
...
func (e *QuestionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *QuestionEntity) Deleted() bool {
	return e.deleted
}


func (e *QuestionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewQuestionEntity(e.client, opts)
}

func (e *QuestionEntity) Data(args ...any) any {
...
func (e *QuestionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Question; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *QuestionEntity) DataTyped(data ...Question) Question {
	if len(data) > 0 {
		return typedFrom[Question](e.Data(asMap(data[0])))
	}
	return typedFrom[Question](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Question (all fields
// optional at the wire level).
func (e *QuestionEntity) MatchTyped(match ...Question) Question {
	if len(match) > 0 {
		return typedFrom[Question](e.Match(asMap(match[0])))
	}
	return typedFrom[Question](e.Match())
}
...
func (e *QuestionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *QuestionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// QuestionLoadMatch and returns an Question. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *QuestionEntity) LoadTyped(reqmatch QuestionLoadMatch, ctrl map[string]any) (Question, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Question{}, err
	}
	return typedFrom[Question](res), nil
}




func (e *QuestionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// QuestionListMatch and returns []Question. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *QuestionEntity) ListTyped(reqmatch QuestionListMatch, ctrl map[string]any) ([]Question, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Question](res), nil
}



func (e *QuestionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *QuestionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *QuestionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *QuestionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
