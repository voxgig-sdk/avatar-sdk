...
func (sdk *AvatarSDK) OptionsMap() map[string]any {
...
func (sdk *AvatarSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *AvatarSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *AvatarSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AvatarSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *AvatarSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *AvatarSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("AvatarSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *AvatarSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AvatarSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("AvatarSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
