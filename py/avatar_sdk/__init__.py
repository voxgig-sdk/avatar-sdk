...
from avatar_sdk.utility import register

# Load features
from avatar_sdk.feature.base_feature import AvatarBaseFeature
from avatar_sdk.features import _has_feature, _make_feature
...
class AvatarSDK:
    ...
    def get_utility(self):
        return AvatarUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("AvatarSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Character(self, data=None) -> "CharacterEntity":
        ...
        from avatar_sdk.entity.character_entity import CharacterEntity
    ...
    def Episode(self, data=None) -> "EpisodeEntity":
        ...
        from avatar_sdk.entity.episode_entity import EpisodeEntity
    ...
    def Question(self, data=None) -> "QuestionEntity":
        ...
        from avatar_sdk.entity.question_entity import QuestionEntity
