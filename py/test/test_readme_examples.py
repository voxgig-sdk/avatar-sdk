# Avatar SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions AvatarSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both AvatarSDK(...) and AvatarSDK.test(...) become
#      AvatarSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "avatar_sdk"
_SDK_CLASS = "AvatarSDK"
