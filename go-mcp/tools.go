...
type Args struct {
	Entity string         `json:"entity" jsonschema:"character | episode | question"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.AvatarSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "avatar_list",
		Description: "List records from Avatar. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "avatar_load",
		Description: "Load a single record from Avatar. " +
...
func runOp(client *sdk.AvatarSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.AvatarSDK, name string) (sdk.AvatarEntity, error) {
	...
	case "question":
		return client.Question(nil), nil
