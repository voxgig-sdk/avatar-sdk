...
AvatarSDK._make_feature = _make_feature


function AvatarSDK.new(options)
  local self = setmetatable({}, AvatarSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function AvatarSDK:options_map()
...
function AvatarSDK:get_utility()
  return Utility.copy(self._utility)
end


function AvatarSDK:get_root_ctx()
  return self._rootctx
end


function AvatarSDK:prepare(fetchargs)
...
function AvatarSDK:direct(fetchargs)
...
-- by passing it.
function AvatarSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function AvatarSDK:graphql(query, variables, ctrl)
...
function AvatarSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = AvatarSDK.new(sdkopts)
  sdk.mode = "test"
