...
If you are an Avatar fan, then this api is for you.

Learn more about Avatar at [sampleapis.com](https://sampleapis.com).
...
This SDK exposes the API as a small set of **semantic entities** — Character, Episode and Question — that you
...
| **Question** | The Question entity (list, load). | `/questions` |
